...
Original file is located at
    https://colab.research.google.com/drive/1dRL8PhJjdEMl0XKN8kfqGmvf3-XOuquW
"""
...
def load_tokenized_dataset(model_name="facebook/nllb-200-distilled-600M"):
    ...
    train_pairs = load_jsonl("train.jsonl", size=32000)
    val_pairs = load_jsonl("val.jsonl", size=512)
    test_pairs = load_jsonl("test.jsonl",size=512)
...
training_args = Seq2SeqTrainingArguments(
    output_dir="/content/drive/MyDrive/ML2_Bublin_Project/Sandra_NLLB/nllb_en-de_finetuned(32K)",
    eval_strategy="epoch",
    save_strategy="epoch",
    ...
    logging_dir="/content/drive/MyDrive/ML2_Bublin_Project/Sandra_NLLB/nllb_en-de_finetuned(32K)/logs",
    logging_steps=100,
    save_total_limit=5,
...
model_path_test = "/content/drive/MyDrive/ML2_Bublin_Project/Sandra_NLLB/nllb_en-de_finetuned(32K)/checkpoint-8000"
