...
# --------------------------
# Define the path to your model checkpoint in Google Drive
...
try:
  ...
  trainer_test = Seq2SeqTrainer(
      model=model_finetuned,                      # T5 model (already finetuned for en-de on cleaned files) - checkpoint-8000 - loaded from the local checkpoint
      args=training_args,                         # Training arguments defined above
